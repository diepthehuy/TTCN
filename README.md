...
<p>Cần cẩn thận khi submit và push lên git vì t có thể push code lên rồi và bản đã pull về từ trước của bro bị chậm 1 submit nên không thể push lên được(phải cùng vs bản submit mới nhất) --> Trước mỗi lần code check xem có cập nhất mới gì không nếu có thì pull code đó về rồi hả code</p>
